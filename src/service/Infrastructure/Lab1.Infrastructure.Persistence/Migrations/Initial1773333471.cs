    ...
    public void GetUpExpressions(IMigrationContext context)
    {
        context.Expressions.Add(new ExecuteSqlStatementExpression
        {
            SqlStatement = """
               ...
               (
                    account_id BIGSERIAL NOT NULL PRIMARY KEY AUTOINCREMENT,
                ...
                (
                    operation_id BIGSERIAL NOT NULL PRIMARY KEY AUTOINCREMENT,
                ...
                (
                    session_id BIGSERIAL NOT NULL PRIMARY KEY AUTOINCREMENT,
                    session_guid STRING NOT NULL UNIQUE,
                );
